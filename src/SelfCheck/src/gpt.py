...
import tiktoken
openai.api_key = 'sk-None-gyvgud0r0HNGFPJnYbz5T3BlbkFJZ5liBnFBWxTeyB55sMIY'
...
model_dict={
    ...
    'gpt-4':{'name': 'gpt-4o-mini', 'req_per_min':3500, 'tok_per_min':90000, 'max_token_per_req': 8192, 'mode': 'chat'}}

#model_choice='gpt-3.5' #Use 'code' for free now.

#Initialize gpt api
def get_response_text(input, model_name='gpt-4o-mini', temp=1.0, n=1, logprobs=5, max_tokens=256, echo=False, stop='null'):
...
def get_response_chat(input, model_name='gpt-4o-mini', temp=1.0, n=1, logprobs=5, max_tokens=256, echo=False, stop='\n'):
